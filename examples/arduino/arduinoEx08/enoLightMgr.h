// Enodia Light Manager
// Brygg Ullmer, Clemson University
// Partial support from NSF CNS-1828611
// Begun 2023-04
// LLGPL3

#ifndef enoLightMgr_h
#define enoLightMgr_h
#endif
...
class enoLightMgr {
  public:
    enoLightMgr(int numLights, int whichChain=0, int maxBrightVal=10);
